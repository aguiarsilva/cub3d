...
#    Updated: 2025/03/26 15:37:16 by baguiar-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		= 	cub3dgame/main.c \
            ...
            initialization/init_data.c initialization/init_mlx.c initialization/init_texts.c initialization/init_movement.c \
            ...
            parsing/validate_player_position.c parsing/validate_texts.c player/collision_detection.c player/player_movement.c player/player_rotation.c \
            rendering/raycasting.c rendering/render_minimap.c rendering/render_texts.c rendering/render.c \
